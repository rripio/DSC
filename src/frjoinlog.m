...
%%
%% Une dos respuestas en magnitud sobre el semiespectro,
%% mezclándolas en un intervalo de índices dado.
%% Asume que las respuestas a unir están en magnitud logarítmica
%% sobre una escala de frecuencias logarítmica.
%%
...
function ssp = frjoinlog(ssp1,ssp2,k1,k2)
    ...
    if (length (ssp1) != length (ssp2))
        error ("frjoinlog: Spectrum lengths must be equal");
    end
